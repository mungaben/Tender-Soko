...
const MainNavBar = () => {
  ...
  return (
    <div className=" w-full fixed top-0 mb-5 z-50 ">
      <div className=" flex md:flex-row  flex-col md:justify-between lg:justify- justify-start  md:mx-4  bg-red-800 ">
        {/* logo */}
        <div className="flex bg-red-500 md:items-start  justify-between    md:flex-row flex-row mx-5 ">
          {/* <LogoImage /> */}
        ...
        {toggle && (
          <motion.div
            ...
            className={`flex md:flex-row lg:flex-1 flex-col justify-center lg:justify-evenly bg-green-600 md:space-x-2  ${
              toggle ? "flex" : "hidden"
            }}`}
          >
            <div
            ...
            >
              ...
              <div className=" md:flex-row flex-col flex justify-around items-center mx-10 my-8 mb-4 ">
                <div className=" flex justify-center md:w-full  items-center">
                  <TenderDrop />
                </div>
                <div className=" flex  md:w-full  justify-center items-center">
                  <SubscribeNav />
                </div>
